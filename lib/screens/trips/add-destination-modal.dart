...
class AddDestinationModal extends StatefulWidget {
  ...
  final Color color;
  @override
  _AddDestinationModal createState() => new _AddDestinationModal(color: this.color, tripId: this.tripId);
    ...
    Container(
      ...
      child: DateTimePickerFormField(
        ...
        validator: (value) {
          ...
          } else if(this.destination['end_date'] < this.destination['start_date']){
